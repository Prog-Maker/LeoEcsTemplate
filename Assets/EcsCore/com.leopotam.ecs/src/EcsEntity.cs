...
namespace Leopotam.Ecs
{
    ...
    public static class EcsEntityExtensions
    {
        ...
        public static ref T Get<T>(in this EcsEntity entity) where T : struct
        {
            ...
            return ref GetComponent<T>(in entity, typeIdx);
        }

        private static ref T GetComponent<T>(in EcsEntity entity, int typeIdx) where T : struct
        {
            ref var entityData = ref entity.Owner.GetEntityData (entity);
#if DEBUG
            if (entityData.Gen != entity.Gen) { throw new Exception("Cant add component to destroyed entity."); }
        ...
        /// <summary>
        /// Checks that component is attached to entity by type name
        /// </summary>
        /// <typeparam name="T">Type of component.</typeparam>
#if ENABLE_IL2CPP
        [Unity.IL2CPP.CompilerServices.Il2CppSetOption (Unity.IL2CPP.CompilerServices.Option.NullChecks, false)]
...
#endif
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool Has(in this EcsEntity entity, string typeName)
        {
            var typeIdx = EcsComponentTypesKeeper.GetTypeIndex (typeName);

            return CheckComponent(in entity, typeIdx);
        }
        ...
        private static bool CheckComponent(in EcsEntity entity, int typeIdx)
        {
            ref var entityData = ref entity.Owner.GetEntityData (entity);
#if DEBUG
        ...
        /// <summary>
        /// Removes component from entity by type name.
        /// </summary>
        /// <typeparam name="T">Type of component.</typeparam>
#if ENABLE_IL2CPP
        [Unity.IL2CPP.CompilerServices.Il2CppSetOption (Unity.IL2CPP.CompilerServices.Option.NullChecks, false)]
...
#endif
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Del(in this EcsEntity entity, string typeName)
        {
            var typeIndex = EcsComponentTypesKeeper.GetTypeIndex(typeName);
            DelComponent(in entity, typeIndex);
        }
        ...
        private static void DelComponent(in EcsEntity entity, int typeIndex)
        {
            ref var entityData = ref entity.Owner.GetEntityData (entity);
